...
type
  GlobalFunction = class
    ...
    class procedure SetFontCombobox(ACombobox : TComboBox; ASize : Single = 12.5); overload;
    class procedure SetFontCombobox(ACombobox : TComboBox; ASize : Single; IsCenter : Boolean); overload;
...
class procedure GlobalFunction.SetFontCombobox(ACombobox: TComboBox;
  ASize: Single; IsCenter: Boolean);
begin
  for var i := 0 to ACombobox.Items.Count - 1 do begin
    ACombobox.ListItems[i].StyledSettings := [];
    ACombobox.ListItems[i].Font.Size := ASize;
    if IsCenter then
      ACombobox.ListItems[i].TextSettings.HorzAlign := TTextAlign.Center;
  end;
